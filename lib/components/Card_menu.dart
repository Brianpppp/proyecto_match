                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            width: MediaQuery.of(context).size.width * 0.2, // Reducir el ancho del contenedor de la imagen
                            height: MediaQuery.of(context).size.width * 0.2, // Reducir el alto del contenedor de la imagen
